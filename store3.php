...
$cdate = date('Y-m-d');
$sql="SELECT * FROM store_3 WHERE expiry_date >= '$cdate'";
$result = mysqli_query($con,$sql);

echo "<b>Products Present in Branch #3</b><br>";
echo "<table border='1'>";
...
<div align="center">
  <form action="rsuccess.php" method="post">
  		...
  		Store ID <input type="number" readonly value="3" name="storeID"  ><br><br>
		Product Required<br>
