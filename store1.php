...
$cdate = date('Y-m-d');
$sql="SELECT * FROM store_1 WHERE expiry_date >= '$cdate'";
$result = mysqli_query($con,$sql);

echo "<b>Products Present in Branch #1</b><br>";
echo "<table border='1'>";
...
<div align="center">
  <form action="rsuccess.php" method="post">
  		...
  		Store ID <input type="number" readonly value="1" name="storeID"  ><br><br>
		Product Required<br>
